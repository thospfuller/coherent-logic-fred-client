...
public enum FilterVariable {
     ...
     * returned from the <a href="https://api.stlouisfed.org/fred/series/updates?api_key=&realtime_start=2001-01-20&realtime_end=2004-05-17&limit=100&offset=1&filter_value=macro">following call</a>.
     */
    geography (GEOGRAPHY);
