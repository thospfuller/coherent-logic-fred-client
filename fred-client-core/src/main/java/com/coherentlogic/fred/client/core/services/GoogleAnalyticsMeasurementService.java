...
public class GoogleAnalyticsMeasurementService {
    ...
    public void fireGAFrameworkUsageEvent () {
        ...
        String response = new QueryBuilder ()
            ...
            .withCIDAsRandomUUID()
            .withTAsEvent()
            .withEc("FRED Client Framework Usage") // event category
            .withAn("FRED Client") // application name
            .withEa("FRED Client Framework Started") // event action
            .withAv("Version 1.0.11-RELEASE") // Application version.
            .withEl("Version 1.0.11-RELEASE")
            .doPost();
